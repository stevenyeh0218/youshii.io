...
<body>
    ...
    <div id="wrapper">
        ...
        <section id="update-content">
            ...
            <div class="main">
                <h4>瀏覽器上傳 </h4>
                <div class="file-name">可接受之檔案軟體 , 僅接受AI、CorelDraw、JPG、TIF、PSD、CSV、TXT、GIF、JPEG、PNG、ICO、PDF、DOC、XLS、RAR、PSB檔，非以上之軟體製作的檔案請自行轉檔。</div>
                <div class="select-name d-flex align-items-center">
                    <div>請填寫資料夾名稱</div>
                    <input type="text" class="inputStyle" id="name" value="">
                </div>
                <div class="drop-file">
                    <div>拖拉檔案到此處</div>
                </div>
