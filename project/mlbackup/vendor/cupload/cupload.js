(function(window, document) {
	...
	var Cupload = function(options) {
		...
		//所需變數
		this.i = 0;
		this.imageArr 		= new Array();//圖片
		this.widthArr 		= new Array();//圖片寬度
		this.heightArr 		= new Array();//圖片高度
		this.imageBox 		= new Array();//圖片盒子
		this.imagePreview 	= new Array();//圖片預覽
		this.imageInput 	= new Array();//圖片input
		this.imageDelete 	= new Array();//圖片刪除遮罩
		this.deleteBtn 		= new Array();//圖片刪除按鈕
		this.sortLeftBtn	= new Array();//圖片左排序按鈕
		this.sortRightBtn	= new Array();//圖片右排序按鈕
	...
	Cupload.prototype = {
		...
		createUploadBtn: function() {
			...
			this.uploadBtn.style.left = this.opt.width*0 + 'px'
			this.uploadBtn.style.right = this.opt.width*0 + 'px'
			this.uploadBtn.style.fontSize = '14px'
			this.uploadBtn.style.color = '#8c939d'
			this.uploadBtn.innerHTML = '點擊或拖拉於此'
		...
		createDeleteBtn: function() {
			...
			this.deleteBtn[this.i].title = '刪除'
		...
		setDefaultImage: function() {
			...
			this.imageDelete[this.i].title = '圖片不存在'
