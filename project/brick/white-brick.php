...
<body>
        ...
        <div class="header-container d-flex align-items-center justify-content-between">
            ...
            <nav class="menu ">
                <ul class="menu-list d-flex align-items-center justify-content-between">
                    ...
                    <li class="menu-item"><a href="#">白磚隔間</a></li>
    ...
    <section id="slideshow" class="banner-inside white-brick"></section>
    <section id="web-intro">
        <div class="intro-contain">
            <div class="cell">
                <div>白磚亦稱ALC或輕質磚</div>
                <div>學名: 高壓蒸壓輕質混凝土塊</div>
                <div>簡稱ALC (Autoclaved Lightweight Concrete)</div>
            </div>

            <div class="cell">
                適用於各種白磚隔間牆工程,包含建築房屋內外牆、屋頂板與樓板 。 現已廣被歐洲、日本等先進國家使用。 優點為輕質（為混凝土之四分之一），導熱率（為混凝土十分之ㄧ），配合綠色能源政策之環保建材。 具輕質、防水、耐火、防蝕、防蛀、抗震、抗壓、抗彎、隔音、隔熱，可降構材載重等優良性能。
            </div>
        </div>
    </section>
